...
trans_cam_dobotBase = [tagMsg.Poses(1).Pose.Pose.Position.X, tagMsg.Poses(1).Pose.Pose.Position.Y,...
    tagMsg.Poses(1).Pose.Position.Z]
rot_cam_dobotBase = quat2rotm(tagMsg.Poses(1).Pose.Pose.Orientation.W, ...
